...
namespace MadEngine
{
    ...
    {
        public MeshRenderer(ShaderWrapper shaderWrapper, Mesh mesh) : base(shaderWrapper, mesh)
        {
        }
        ...
        protected override void Draw(Camera camera, Matrix4 localMatrix, Matrix4 parentMatrix)
        {
            ...
            if(_shaderWrapper is TesselationShadedShaderWrapper wrapper)
            {
